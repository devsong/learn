package com.gzs.learn.backend.admin.core.freemarker.utils;
...
public class FreemarkerTagUtil {
     ...
     * @throws TemplateException
     */
    public static void clearTempleModel(Environment env, Map<String, TemplateModel> params, Map<String, TemplateModel> origMap)
            throws TemplateException {
        if (params.size() <= 0) {
            return;
        }
