package com.gzs.learn.backend.admin.core.freemarker.extend;
...
import com.gzs.learn.backend.admin.core.tags.APITemplateModel;
import com.gzs.learn.backend.admin.utils.SpringContextUtil;
import com.gzs.learn.backend.admin.utils.UtilPath;
...
public class Ferrmarker {
    ...
    static {
        ...
        /**添加自定义标签*/
        APITemplateModel api = SpringContextUtil.getBean(APITemplateModel.class);
        cfg.setSharedVariable("api", api);

        FreeMarkerConfigExtend ext = SpringContextUtil.getBean(FreeMarkerConfigExtend.class);
