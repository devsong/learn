package com.gzs.learn.backend.admin.core.mybatis;
...
import com.gzs.learn.backend.admin.core.mybatis.page.MysqlDialect;
...
public class BaseMybatisDao<T> extends SqlSessionDaoSupport {
     ...
     * @throws SQLException
     */
    private PreparedStatement getPreparedStatement(String sql, List<ParameterMapping> parameterMappingList, Map<String, Object> params,
